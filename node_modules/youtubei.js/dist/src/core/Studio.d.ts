...
declare class Studio {
     ...
     * ```
     */
    updateVideoMetadata(video_id: string, metadata: VideoMetadata): Promise<AxioslikeResponse>;
    /**
     ...
     * ```
     */
    upload(file: BodyInit, metadata?: UploadedVideoMetadata): Promise<AxioslikeResponse>;
}
