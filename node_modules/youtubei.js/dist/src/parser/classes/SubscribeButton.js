...
const SubscriptionNotificationToggleButton_1 = __importDefault(require("./SubscriptionNotificationToggleButton"));
...
class SubscribeButton extends helpers_1.YTNode {
    constructor(data) {
        ...
        this.notification_preference_button = index_1.default.parseItem(data.notificationPreferenceButton, SubscriptionNotificationToggleButton_1.default);
